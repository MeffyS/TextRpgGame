...
class PlayerPotionPocket:
    ...
    def open_pocket(cls):
        ...
        disagree = "Q"
        while True:
            explore_pocket = input("Do you want open pocket? [Y][Q] ").upper()
        ...
        if move == "POCKET":
            while True:
                ...
                for (
                    pocket_item,
                    pocket_item_count,
                ) in player_backpack.potion_pocket.items():
                    print(pocket_item_count, pocket_item)
                item_name = input("Enter a item or [Q] ")
                if item_name in player_backpack.potion_pocket:

                    if (
                        item_name == str(PocketOptions.HealthPotion.value)
                        or item_name == PocketOptions.HealthPotion.name
                    ):
                        ...
                        item_name == str(PocketOptions.ManaPotion.value)
                        or item_name == PocketOptions.ManaPotion.name
                    ):
                        if player.mana > player.max_mana:
                        ...
                        item_name == str(PocketOptions.StaminaPotion.value)
                        or item_name == PocketOptions.StaminaPotion.name
                    ):
