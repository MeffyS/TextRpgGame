...
class NewBank:
        ...
        while True:
            ...
            try:
                if int(deposit) > player_backpack.coins:
                    print(
                        f"You dont have {int(deposit)} in pocket. In Your pocket balance you got {player_backpack.coins}"
                    )
                elif int(deposit) == 0:
                    ...
                    print(
                        f"You deposit to bank {deposit} coins. You have a {player_backpack.coins} coins in pocket"
                    )
                break
            except ValueError:
                if deposit == "Q":
    ...
    def withdraw(self):
        ...
        try:
            if int(withdraw) > self.balance:
                print(
                    f"You dont have {int(withdraw)} in bank. In Your bank balance you got {self.balance}"
                )
            elif int(withdraw) == 0:
                ...
                print(
                    f"You withdraw to bank {withdraw} coins. You have a {self.balance} coins in pocket"
                )
        except ValueError:
            if withdraw == "Q":
                pass
    ...
    def pocket_balance():
        print(
            f"Dear player, your total pocket balance is {player_backpack.coins} coins"
        )
        ...
        while True:
            ...
            try:
                if (
                    ...
                    or int(bank_choice) == BankOptions.DEPOSIT.value
                ):
                    self.deposit()
                elif (
                    bank_choice == BankOptions.WITHDRAW.name
                    or int(bank_choice) == BankOptions.WITHDRAW.value
                ):
                    self.withdraw()
                elif (
                    bank_choice == BankOptions.BALANCE.name
                    or int(bank_choice) == BankOptions.BALANCE.value
                ):
                    self.bank_balance()
                elif (
                    bank_choice == BankOptions.POCKET.name
                    or int(bank_choice) == BankOptions.POCKET.value
                ):
